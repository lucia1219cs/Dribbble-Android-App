...
public class NewBucketFragment extends DialogFragment {
    ...
    protected static final String KEY_BUCKET_NAME = "bucket_name";
    protected static final String KEY_BUCKET_DESCRIPTION = "bucket_description";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_new_bucket, null);
        ButterKnife.bind(this, view);

        return new AlertDialog.Builder(getContext())
                .setTitle(R.string.new_bucket_title)
                .setView(view)
                .setPositiveButton(R.string.new_bucket_create,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                getTargetFragment().onActivityResult(BucketListFragment.REQ_CODE_NEW_BUCKET, Activity.RESULT_OK, intent);
                                dismiss();
                            }
                        }
                )
